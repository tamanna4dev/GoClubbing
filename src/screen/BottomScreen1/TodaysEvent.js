...
const TodaysEvent = ({navigation}) => {
  ...
  <Text style={{fontSize:20,fontWeight:700,color:'#363636'}}>Today’s Event</Text>
...
<TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate('Casinova')
          }}>
      <Image source={require('../../Assets/image/33.png')} style={{ height: 208, width: 323,borderTopLeftRadius: 7, borderTopRightRadius: 7,}} />
    ...
    <Text style={{backgroundColor:'#E8505B',color:'#fff',borderWidth:1,borderColor:'#E8505B',borderRadius:15,textAlign:'center',width:116,height:26,padding:3}}>View Details</Text>
        ...
        <Image source={require('../../Assets/image/34.png')} style={{ height: 208, width: 323,borderTopLeftRadius: 7, borderTopRightRadius: 7,}} />
        <View style={{ backgroundColor: 'rgb(242 236 236)',width:323, padding:10,}}>
