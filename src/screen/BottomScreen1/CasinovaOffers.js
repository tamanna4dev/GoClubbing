...
const CasinovaOffers = ({navigation}) => {
  return (
...
<Text style={{color:'#E8505B',borderWidth:1,borderColor:'#E8505B',borderRadius:5,textAlign:'center',width:80,height:26,padding:2}}>Details</Text>
   <Text style={{backgroundColor:'#E8505B',color:'#fff',borderWidth:1,borderColor:'#E8505B',borderRadius:5,textAlign:'center',width:76,height:26,padding:3}}>Offers</Text>
   <TouchableOpacity
        
        onPress={() => {
          navigation.navigate('CasinovaUpcomingEvents')
        }}>
 <Text style={{color:'#E8505B',borderWidth:1,borderColor:'#E8505B',borderRadius:5,textAlign:'center',width:117,height:26,padding:2}}>Upcoming Events</Text>
    ...
    <Text style={{color:'#828282',fontSize:14,marginVertical:4,fontWeight:600,}}>      Happy hours: 6:30pm to 7.30pm</Text> 
    <Text style={{color:'#828282',fontSize:14,marginVertical:4,fontWeight:600}}>      Free drinks for girls from 9.30pm-10.30pm </Text> 
    <Text style={{color:'#828282',fontSize:14,marginVertical:4,fontWeight:600}}>      10% discount for VIP card</Text> 
