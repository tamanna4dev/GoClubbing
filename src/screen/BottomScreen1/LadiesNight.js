...
const LadiesNight = () => {
  ...
  <Text style={{fontSize:20,fontWeight:700,color:'#363636'}}>Ladies Night @Casino’va</Text>
...
<Text style={{color:'#263238',fontSize:15,fontWeight:500}}>Event DIscription</Text>
